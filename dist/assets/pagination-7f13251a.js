import{r,j as a,G as i,p as n,M as o,ad as W,_ as E,Q as c,T as H,D as L}from"./index-385486e1.js";import{C as N}from"./ComponentHeader-68d9f612.js";import{C as D,a as Q}from"./ComponentSkeleton-5c04c834.js";import{P as e}from"./Pagination-ad14ccaa.js";import{T as V}from"./TablePagination-1d311dcd.js";import"./Skeleton-81b92fc8.js";import"./KeyboardArrowRight-8746d11f.js";import"./TableCell-a3c8540c.js";const Z=()=>{const[P,u]=r.useState(2),[m,h]=r.useState(10),x=(t,s)=>{u(s)},j=t=>{h(parseInt(t.target.value,10)),u(0)},[l,v]=r.useState(10),[f,d]=r.useState(!1),y=t=>{v(+t.target.value)},C=()=>{d(!1)},S=()=>{d(!0)},[b,g]=r.useState(1),[w,p]=r.useState(1),I=(t,s)=>{g(s)},M=t=>{+t.target.value>0&&+t.target.value<=100/l?(p(+t.target.value),g(+t.target.value)):p("")},z=`<Pagination count={10} defaultPage={1} color="primary" />
