import{r,j as a,G as i,p as n,M as o,ad as W,_ as E,Q as c,T as H,D as L}from"./index-f4d20eae.js";import{C as N}from"./ComponentHeader-5b110491.js";import{C as D,a as Q}from"./ComponentSkeleton-befdc25a.js";import{P as e}from"./Pagination-91a78fe5.js";import{T as V}from"./TablePagination-2db44220.js";import"./Skeleton-4ff65c76.js";import"./KeyboardArrowRight-1b7cf50b.js";import"./TableCell-c89ef8e0.js";const Z=()=>{const[P,u]=r.useState(2),[m,h]=r.useState(10),x=(t,s)=>{u(s)},j=t=>{h(parseInt(t.target.value,10)),u(0)},[l,v]=r.useState(10),[f,d]=r.useState(!1),y=t=>{v(+t.target.value)},C=()=>{d(!1)},S=()=>{d(!0)},[b,g]=r.useState(1),[w,p]=r.useState(1),I=(t,s)=>{g(s)},M=t=>{+t.target.value>0&&+t.target.value<=100/l?(p(+t.target.value),g(+t.target.value)):p("")},z=`<Pagination count={10} defaultPage={1} color="primary" />
