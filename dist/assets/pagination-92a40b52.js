import{r,j as a,G as i,p as n,M as o,ad as W,_ as E,Q as c,T as H,D as L}from"./index-22c328f7.js";import{C as N}from"./ComponentHeader-c43235a9.js";import{C as D,a as Q}from"./ComponentSkeleton-c6eec1fd.js";import{P as e}from"./Pagination-b2be339d.js";import{T as V}from"./TablePagination-b68fd889.js";import"./Skeleton-276ea468.js";import"./KeyboardArrowRight-982fdffa.js";import"./TableCell-97ce9cb3.js";const Z=()=>{const[P,u]=r.useState(2),[m,h]=r.useState(10),x=(t,s)=>{u(s)},j=t=>{h(parseInt(t.target.value,10)),u(0)},[l,v]=r.useState(10),[f,d]=r.useState(!1),y=t=>{v(+t.target.value)},C=()=>{d(!1)},S=()=>{d(!0)},[b,g]=r.useState(1),[w,p]=r.useState(1),I=(t,s)=>{g(s)},M=t=>{+t.target.value>0&&+t.target.value<=100/l?(p(+t.target.value),g(+t.target.value)):p("")},z=`<Pagination count={10} defaultPage={1} color="primary" />
