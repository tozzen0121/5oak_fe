import{r,j as a,G as i,p as n,M as o,ad as W,_ as E,Q as c,T as H,D as L}from"./index-753a7d60.js";import{C as N}from"./ComponentHeader-34de432c.js";import{C as D,a as Q}from"./ComponentSkeleton-437d0355.js";import{P as e}from"./Pagination-f08e9217.js";import{T as V}from"./TablePagination-c71c1422.js";import"./Skeleton-12c184b4.js";import"./KeyboardArrowRight-39cf7076.js";import"./TableCell-79ad539b.js";const Z=()=>{const[P,u]=r.useState(2),[m,h]=r.useState(10),x=(t,s)=>{u(s)},j=t=>{h(parseInt(t.target.value,10)),u(0)},[l,v]=r.useState(10),[f,d]=r.useState(!1),y=t=>{v(+t.target.value)},C=()=>{d(!1)},S=()=>{d(!0)},[b,g]=r.useState(1),[w,p]=r.useState(1),I=(t,s)=>{g(s)},M=t=>{+t.target.value>0&&+t.target.value<=100/l?(p(+t.target.value),g(+t.target.value)):p("")},z=`<Pagination count={10} defaultPage={1} color="primary" />
