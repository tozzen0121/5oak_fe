import{c as W,r as d,j as e,G as S,p as c,M as t}from"./index-884300a6.js";import{C as E}from"./ComponentHeader-323d5cd5.js";import{C as G,a as H}from"./ComponentSkeleton-fe2914a1.js";import{S as a}from"./Slider-b1218a2d.js";import{A as B,S as $}from"./SoundOutlined-ae6c5e80.js";import"./Skeleton-5c7a6d8d.js";import"./visuallyHidden-14c3de6e.js";function i(s){return`${s}°C`}function q(s){return p.findIndex(u=>u.value===s)+1}const r=10,p=[{value:0,label:"0°C"},{value:20,label:"20°C"},{value:37,label:"37°C"},{value:100,label:"100°C"}],Y=()=>{const s=W(),[u,b]=d.useState(55),v=(g,l)=>{b(l)},[f,V]=d.useState([20,37]),j=(g,l)=>{V(l)},[n,h]=d.useState([20,55]),C=(g,l,x)=>{Array.isArray(l)&&h(x===0?[Math.min(l[0],n[1]-r),n[1]]:[n[0],Math.max(l[1],n[0]+r)])},[y,m]=d.useState([35,76]),A=(g,l,x)=>{if(Array.isArray(l))if(l[1]-l[0]<r)if(x===0){const o=Math.min(l[0],100-r);m([o,o+r])}else{const o=Math.max(l[1],r);m([o-r,o])}else m(l)},L="<Slider defaultValue={35} />",T=`<Stack spacing={2} direction="row" sx={{ mb: 1 }} alignItems="center">
