import{r as j,j as e,B as g,F as t,G as n,p as s,M as a,ad as f,ae as p}from"./index-f4d20eae.js";import{C as F}from"./ComponentHeader-5b110491.js";import{C as S,a as P}from"./ComponentSkeleton-befdc25a.js";import{C as o}from"./Checkbox-20ad8cf0.js";import"./Skeleton-4ff65c76.js";const y=()=>{const[l,r]=j.useState([!0,!1]),d=c=>{r([c.target.checked,c.target.checked])},h=c=>{r([c.target.checked,l[1]])},i=c=>{r([l[0],c.target.checked])},x=e.jsxs(g,{sx:{display:"flex",flexDirection:"column",ml:3},children:[e.jsx(t,{label:"Child 1",control:e.jsx(o,{checked:l[0],onChange:h})}),e.jsx(t,{label:"Child 2",control:e.jsx(o,{checked:l[1],onChange:i})})]}),C=`<Checkbox />
