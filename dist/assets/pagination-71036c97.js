import{r,j as a,G as i,p as n,M as o,ad as W,_ as E,Q as c,T as H,D as L}from"./index-00d10488.js";import{C as N}from"./ComponentHeader-2988d0fc.js";import{C as D,a as Q}from"./ComponentSkeleton-5bbc5a2f.js";import{P as e}from"./Pagination-f474a403.js";import{T as V}from"./TablePagination-ac47bd2e.js";import"./Skeleton-a874ac2b.js";import"./KeyboardArrowRight-11247ccb.js";import"./TableCell-4b2001a9.js";const Z=()=>{const[P,u]=r.useState(2),[m,h]=r.useState(10),x=(t,s)=>{u(s)},j=t=>{h(parseInt(t.target.value,10)),u(0)},[l,v]=r.useState(10),[f,d]=r.useState(!1),y=t=>{v(+t.target.value)},C=()=>{d(!1)},S=()=>{d(!0)},[b,g]=r.useState(1),[w,p]=r.useState(1),I=(t,s)=>{g(s)},M=t=>{+t.target.value>0&&+t.target.value<=100/l?(p(+t.target.value),g(+t.target.value)):p("")},z=`<Pagination count={10} defaultPage={1} color="primary" />
