...
// render admin page
const HomePage = Loadable(lazy(() => import('pages/admin/home')));
const GameList = Loadable(lazy(() => import('pages/admin/games')));
const GameForm = Loadable(lazy(() => import('pages/admin/games-form')));
const TeamList = Loadable(lazy(() => import('pages/admin/team')));
const TeamForm = Loadable(lazy(() => import('pages/admin/employee-form')));
const NewsList = Loadable(lazy(() => import('pages/admin/news')));
const NewsForm = Loadable(lazy(() => import('pages/admin/news-form')));
const JobList = Loadable(lazy(() => import('pages/admin/jobs')));
const JobForm = Loadable(lazy(() => import('pages/admin/job-form')));
const CareersList = Loadable(lazy(() => import('pages/admin/careers')));
const Applicant = Loadable(lazy(() => import('pages/admin/applicant')));
const ContactsList = Loadable(lazy(() => import('pages/admin/contacts')));
const Enquery = Loadable(lazy(() => import('pages/admin/enquery')));
const ReportPage = Loadable(lazy(() => import('pages/admin/report')));
const ReportOnePage = Loadable(lazy(() => import('pages/admin/report-one')));
const ReportTypePage = Loadable(lazy(() => import('pages/admin/report-type')));
// ==============================|| MAIN ROUTING ||============================== //
